...
function DirectorOutreachDashboard() {
  ...
  return (
    <div className="page-container director-outreach-container">
      <div className="page-header"> <h1>Team Outreach Dashboard</h1> <p className="subtitle">Real-time visibility into recruiter LinkedIn activity</p> <p style={{ color: 'yellow', fontSize: '1rem', marginTop: '5px' }}>Now powered by Hire Logic AI</p> </div>
