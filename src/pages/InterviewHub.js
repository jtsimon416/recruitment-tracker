...
const InterviewHistoryTab = ({ interviews, onViewDetails }) => {
  ...
  const filteredGroups = useMemo(() => {
    return groupedInterviews.filter(group => {
      ...
      // Removed matchesPosition filter
      return matchesSearch;
    });
  }, [groupedInterviews, searchQuery]); // Removed filterPosition from dependencies

  // Removed positions useMemo
